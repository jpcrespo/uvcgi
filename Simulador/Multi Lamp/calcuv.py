...
#dimensionalmente el tiempo esta en segundos
	...
	print('tiempo para D99.99= '+str(round(tmin,3))+' segundos ' + 'BoosT')
...
#La intensidad se encuentra en microW/cm2
	...
	print('tiempo para D99.99= '+str(round(t_emin,3))+' segundos ' + 'Total')
	return tmin, t_emin
...
if __name__=='__main__':
	...
	ks=KillRate(8000,intensidad)
	
	pl_uvsup(40,ks,coord)
	pl_uvfront(10,ks,coord)
